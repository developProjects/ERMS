...
<html lang="en">
 ...
 <meta http-equiv="x-ua-compatible" content="IE=10">
	...
	function toEdit(crId){
		window.location = "/ermsweb/issuerLimitChangeRequestUpdate?crId="+crId;
	}
	function toDiscard(crId){
		window.location = "/ermsweb/issuerLimitChangeRequestDiscard?crId="+crId;
	}
	function toBack(){
		//window.history.back();
    ...
    <body>
    	<div class="boci-wrapper">
    		...
    		<div class="content-wrapper">
					<div class="page-title">Maintenance  - Issuer Limit Maintenance (Collateral) - View Issuer Limit Change Request (Collateral)</div>	    		
