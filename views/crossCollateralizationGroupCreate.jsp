    	...
    	xcollGroupTypeDataSource = [
				...
				$("#resetBtn").kendoButton({
		    	 ...
		    	 var xcollGroupData = new kendo.data.DataSource({
						transport: {
							read: {
								url: "/ermsweb/resources/js/lpbybu1.json",
								dataType: "json",
								complete: function (){
									emptyHeight('group-list');
								} 
								}
							},
							schema: {
				...
				$("#docMapListContainer").on("click", ".file-delete", function (e) {
				 ...
				 var xcollCreateGroup = new kendo.data.DataSource({
					 transport: {
							create:{
								type:"POST",
								url: window.sessionStorage.getItem('serverPath')+"xcollGroup/submit",
								dataType: "json",
								xhrFields: {
		                        	withCredentials: true
		                        },
				 ...
				 $("#saveBtn").kendoButton({
						click: function(){
							...
							xcollCreateGroup.transport.options.create.url = window.sessionStorage.getItem('serverPath')+"xcollgroup/save";
							/* var xcollGroup = {
									"xcollGroupId": null,
									"crId": null,
									"xcollGroupType": $("#xcollGroupType").data("kendoDropDownList").value(),
									"xcollGroupName": $("#xcollGroupName").val(),
									"crStatus": "Saved",
									"crAction": "CREATE",
									"crRemark": null,
									"createBy": "RISKADMIN",
									"createDt": 1454667854000,
									"crBy": null,
									"crDt": null,
									"verifyBy": null,
									"verifyDt": null,
									...
									"lastUpdatedBy": "RISKADMIN",
									"lastUpdateDt": 1454667854000,
									"xcollGroupMemList":gridData()
							}; */
							xcollCreateGroup.add({
				...
				$("#submitBtn").kendoButton({
					click: function(){
						xcollCreateGroup.transport.options.create.url= window.sessionStorage.getItem('serverPath')+"xcollgroup/submit";
						/* var xcollGroup = {
    	...
    	<div class="boci-limitType-wrapper">
    		...
    		<div class="createLimit-content-wrapper form">
    			<form id="countryRating_form">
					<div class="page-title">Maintenance - Cross Collateralization Group Maintenance  -  Create Cross Collaterialization Group</div>	    		
