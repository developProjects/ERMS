 	...
 	<script type="text/javascript">
 	 ...
 	 $(document).ready(function () {
		...
		function dataGrids(){
			...
			$(".empty-height").hide();
			openModal();
			var getLsfPeDlyMonEnqURL = window.sessionStorage.getItem('serverPath')+"expoLSFPE/getT24LoanSummary?userId="+window.sessionStorage.getItem('username')+"&bizUnit="+$("#dropValue").val()+"&rmdGroupId="+$('#grpDesc').val()+"&loanTxNo="+$('#LoanId').val()+"&pageSize=10&skip=0";;
