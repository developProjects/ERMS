    ...
    $(document).ready(function(){
    	...
    	var dataSource = new kendo.data.DataSource({
			transport: {
				...
				update:{
					type:"POST",
					url: window.sessionStorage.getItem('serverPath')+"xcollgroup/discard",
					dataType: "json",
			...
			dataSource.fetch(function(){
				...
				$.each(jsonObj, function(i){
						...
						$(".confirm-del").html("<div>"+ "Discard the change on Cross Collateralization Group   "+validateResponse(jsonObj[i].xcollGroupId)+" " + "</div>");
						...
						$("#group-list").on("click", ".grid-row-view", function (e) {
							...
							$.each(dataItem.docMapList, function(i){
								$("#docMapList").append("<div><a href=\"javascript:void(0)\" >"+validateResponse(dataItem.docMapList[i].fileName)+"</a></div>");	
							});
