			...
			dataSource.fetch(function(){
				...
				$.each(jsonObj, function(i){
					...
					$("#crAction").html(validateResponse(jsonObj[i].crAction));
						$(".confirm-del").html("<div>"+ "Discard the change on "+validateResponse(jsonObj[i].lmtTypeCode)+"?" + "</div>");
						$("#remarks").html("<label>"+validateResponse(jsonObj[i].status)+"</label>");
    	...
    	<div class="boci-limitType-wrapper">
    		...
    		<div class="viewLimitTypeDetails-content-wrapper form">
    			<form id="create_newlimit_form">
					<div class="page-title">Maintenance - Limit Type Maintenance-Discard Limit Type Change Request</div>	    		
	    			<!-- <input type="hidden" id="pagetitle" name="pagetitle" value="Discard Limit Type Change Request"> -->
				...
				<div id="approval-section-header">Approval</div>
					<table id="approval-section-table">
						...
						<tr>
							<td width="195.5"  class="bold" style="vertical-align:top">Remarks</td>
							<td width="300">
								<div style="background-color:#FCD5B4;min-height:80px;"><label id="remarks">Verifer Reamrks will come here</label></div>
							</td>
						</tr>		
					</table>
				</div>
