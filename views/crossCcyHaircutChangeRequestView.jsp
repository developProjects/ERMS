...
<html lang="en">
 ...
 <meta http-equiv="x-ua-compatible" content="IE=10">
	...
	function toEdit(ccyCode,bizUnit,crId){
		window.location = "/ermsweb/crossCcyHaircutChangeRequestUpdate?crId="+crId+"&ccyCode="+ccyCode+"&bizUnit="+bizUnit;
	}
	function toDiscard(ccyCode,bizUnit,crId){
		window.location = "/ermsweb/crossCcyHaircutDiscardChangeRequest?crId="+crId+"&ccyCode="+ccyCode+"&bizUnit="+bizUnit;
	}
	function toBack(){
		//window.history.back();
    ...
    <body>
    	<div class="boci-limitType-wrapper">
    		...
    		<div class="viewLimitTypeDetails-content-wrapper form">
					<div class="page-title">Maintenance  -  Cross Currency Haircut Maintenance - Cross Currency Haircut Change Request View</div>	    		
					...
					<div id="approval-section-header">Approval</div>
						<table id="approval-section-table">
							<tr>
								...
								<td><label class="bold">Update of Cross Currency Haircut</label></td>
							</tr>
							<tr>
