 	...
 	<script type="text/javascript">
 	 ...
 	 $(document).ready(function () {
		...
		function dataGrids(){
			...
			$(".empty-height").hide();
			openModal();
			//var getSblTxnDetailURL = "/ermsweb/resources/js/getSblTxnDetailRpt?userId="+window.sessionStorage.getItem('username')+"&ccdId="+$('#ccdId').val();
		...
		function expandCriteria(){
			...
			<!-- <div width="1000"> -->
				...
				<br>
				<div id="limitHeader" style="background-color:#B54D4D; color:#fff;margin-bottom: 30px; padding:4px 0px 4px 0px;">LOAN STOCK EXPOSURE MONITORING</div>
				
				
<!-- Large Exposure Conditinal search criteria starts-->
			<div id="limitData">
			<!-- <div style="background-color:pink; width:1000" class="pageTitle">LOAN STOCK EXPOSURE MONITORING </div> -->
