 				...
 				function(){
					...
					*/
					...
					var dataSource = new kendo.data.DataSource({
						transport: {
							read: {
								url: window.sessionStorage.getItem('serverPath')+"subacct/getRecord?acctId="+array[0]+"&subAcc="+getURLParameters("subAcc")+"&bizUnit="+array[1]+"&bookEntity="+array[2]+"&dataSourceAppId="+array[3]+"&userId="+window.sessionStorage.getItem("username"),
								dataType: "json",
				...
				dataSource.fetch(function(){	
					...
					$("#saveBtn").kendoButton({
		    			click: function(){
		    				...
		    				dataDatasource.set("acctId",updateCriteria.acctId);
...
<body>
	<div id="boci-wrapper">
		...
		<div class="page-title">Sub Account RMD Maintenance - Update </div>
		<!-- <input type="hidden" id="pagetitle" name="pagetitle"
			value="Sub Account RMD Maintenance - Update "> -->
