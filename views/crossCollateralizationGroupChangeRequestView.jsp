...
<html lang="en">
 ...
 <meta http-equiv="x-ua-compatible" content="IE=10">
	...
	function toEdit(crId){
		window.location = "/ermsweb/crossCollateralizationGroupChangeRequestUpdate?crId="+crId;
	}
	function toDiscard(crId){
		window.location = "/ermsweb/crossCollateralizationGroupChangeRequestDiscard?crId="+crId;
	}
	function toBack(){
		//window.history.back();
