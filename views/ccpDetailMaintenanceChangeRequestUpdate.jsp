...
<script>
			...
			*/
			...
			dataSource.fetch(function(){
				...
				$.each(jsonObj, function(i){
						...
						$("#client_counterparty_category_label").html("<input style=\"width:100%\" class=\"k-textbox\"  id='cc_category' value='"+validateResponse(jsonObj[i].legalPartyCat)+"'/>");
						...
						$("#financial_report_date_label").html("<input style=\"width:100%\" class=\"k-textbox\"  id='latestFinRptDate' value='"+validateResponse(toDateFormat(jsonObj[i].latestFinRptDate))+"'/>");
						...
						$("#checkEXTKey1").html("<input style=\"width:100%\" class=\"k-textbox\"  type='text' value='"+checkUndefinedElement(jsonObj[i].externalKey1)+"'/>");
						$("#checkEXTKey2").html("<input style=\"width:100%\" class=\"k-textbox\"  type='text' value='"+checkUndefinedElement(jsonObj[i].externalKey2)+"'/>");
						$("#checkEXTKey3").html("<input style=\"width:100%\" class=\"k-textbox\"  type='text' value='"+checkUndefinedElement(jsonObj[i].externalKey3)+"'/>");
						$("#checkEXTKey4").html("<input style=\"width:100%\" class=\"k-textbox\"  type='text' value='"+checkUndefinedElement(jsonObj[i].externalKey4)+"'/>");
						$("#checkEXTKey5").html("<input style=\"width:100%\" class=\"k-textbox\"  type='text' value='"+checkUndefinedElement(jsonObj[i].externalKey5)+"'/>");
						$("#checkEXTKey6").html("<input style=\"width:100%\" class=\"k-textbox\"  type='text' value='"+checkUndefinedElement(jsonObj[i].externalKey6)+"'/>");
						$("#checkEXTKey7").html("<input style=\"width:100%\" class=\"k-textbox\"  type='text' value='"+checkUndefinedElement(jsonObj[i].externalKey7)+"'/>");
						$("#checkEXTKey8").html("<input style=\"width:100%\" class=\"k-textbox\"  type='text' value='"+checkUndefinedElement(jsonObj[i].externalKey8)+"'/>");
						$("#checkEXTKey9").html("<input style=\"width:100%\" class=\"k-textbox\"  type='text' value='"+checkUndefinedElement(jsonObj[i].externalKey9)+"'/>");
						$("#checkEXTKey10").html("<input style=\"width:100%\" class=\"k-textbox\"  type='text' value='"+checkUndefinedElement(jsonObj[i].externalKey10)+"'/>");
						$("#verifierRemarks").html(jsonObj[i].verifierRemarks);
						$("#buttonType").html("<button id=\"saveBtn\"  type=\"button\" data-role=\"button\" class=\"k-button\" role=\"button\" aria-disabled=\"false\" tabindex=\"0\" >Save</button><label>    </label><button id=\"submitBtn\" type=\"button\" data-role=\"button\" class=\"k-button\" role=\"button\" aria-disabled=\"false\" tabindex=\"0\">Submit</button><label>    </label><button id=\"discardBtn\" type=\"button\" data-role=\"button\" class=\"k-button\" role=\"button\" aria-disabled=\"false\" tabindex=\"0\" onclick=\"toDiscard('"+jsonObj[i].crId+"', '"+jsonObj[i].ccdId+"')\">Discard</button><label>    </label><button id=\"clearBtn\"  type=\"button\" data-role=\"button\" class=\"k-button\" role=\"button\" aria-disabled=\"false\" tabindex=\"0\" onclick=\"toClear()\">Clear</button><label>    </label><button id=\"backBtn\" onclick=\"toBack()\" type=\"button\" data-role=\"button\" class=\"k-button\" role=\"button\" aria-disabled=\"false\" tabindex=\"0\">Back</button>");   								
				});
		...
		function toDiscard(uid, ccdId){
			window.location = "/ermsweb/viewDiscardCounterParty?crId="+uid+"&ccdId="+ccdId+"&userId"+window.sessionStorage.getItem("username");
		}
...
<body>
	...
	<div class="page-title">Maintenance - Client Counterparty RMD Detail Maintenance - View Client Counterparty Detail</div>
	<!-- <input type="hidden" id="pagetitle" name="pagetitle"
		value="Maintenance - Client Counterparty RMD Detail Maintenance - View Client Counterparty Detail">
	<br> -->
	...
	<table border="0" style="background-color: #fabf8f">
		...
		<tr>
			...
			<td width="250" style="font-size: 13px"><label
				id="verifierRemarks"></label></td>
		</tr>
	</table>
	<br />
