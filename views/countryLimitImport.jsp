...
<html lang="en">
 ...
 <meta http-equiv="x-ua-compatible" content="IE=10">
    ...
    $(document).ready(function(){
    	...
    	$('#importBtn').on('click', function(){
	         $("#files").kendoUpload({
	             ...
	             async: {
	                 saveUrl: window.sessionStorage.getItem('serverPath')+"countrylmt/upload?userId="+window.sessionStorage.getItem("username"),
	                 xhrFields: {
   ...
   function onSuccess(e){
	...
	function toBack(){
		//window.history.back();
		window.location = "/ermsweb/countrylmtMaintenance";
	}
    ...
    <body>
    	<div class="boci-wrapper">
    		...
    		<div class="content-wrapper">
					<div class="page-title">Maintenance  - Country Limit Maintenance (Collateral) - Import </div>	    		
