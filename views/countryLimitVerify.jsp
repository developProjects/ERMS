    ...
    $(document).ready(function(){
    	...
    	var dataSource = new kendo.data.DataSource({
			transport: {
				...
				update:{
					type:"POST",
					url: window.sessionStorage.getItem('serverPath')+"countrylmt/verify",
					dataType: "json",
			...
			dataSource.fetch(function(){
				...
				$("#verifyBtn").kendoButton({
	    			click: function(){
	    				...
	    				dataSource.transport.options.update.url= window.sessionStorage.getItem('serverPath')+"countrylmt/verify";
	      		...
	      		$("#returnBtn").kendoButton({
	    			click: function(){    				
	    				var dataDatasource = dataSource.at(0);
	    				dataSource.transport.options.update.url= window.sessionStorage.getItem('serverPath')+"countrylmt/return";
    ...
    <body>
    	<div class="boci-wrapper">
    		...
    		<div class="content-wrapper">
					<div class="page-title">Maintenance  - Country Limit Maintenance (Collateral) - Verify Country Limit Change Request (Collateral)</div>	    		
