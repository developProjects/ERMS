    ...
    $(document).ready(function(){
    	...
    	var dataSource = new kendo.data.DataSource({
			transport: {
				...
				update:{
					type:"POST",
					url: window.sessionStorage.getItem('serverPath')+"issuerlmt/verify",
					dataType: "json",
			...
			dataSource.fetch(function(){
				...
				$.each(jsonObj, function(i){
						...
						$("#lmtInLoan").html("<label>"+validateResponse(jsonObj[i].lmtInCapital)+"</label>");
				...
				$("#verifyBtn").kendoButton({
	    			click: function(){
	    				...
	    				dataSource.transport.options.update.url= window.sessionStorage.getItem('serverPath')+"issuerlmt/verify";
	      		...
	      		$("#returnBtn").kendoButton({
	    			click: function(){    				
	    				var dataDatasource = dataSource.at(0);
	    				dataSource.transport.options.update.url= window.sessionStorage.getItem('serverPath')+"issuerlmt/return";
    ...
    <body>
    	<div class="boci-wrapper">
    		...
    		<div class="content-wrapper">
					<div class="page-title">Maintenance  - Issuer Limit Maintenance (Collateral) - Verify Issuer Limit Change Request (Collateral)</div>	    		
