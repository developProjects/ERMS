    ...
    $(document).ready(function(){
    	...
    	var dataSource = new kendo.data.DataSource({
			transport: {
				...
				update:{
					type:"POST",
					url: window.sessionStorage.getItem('serverPath')+"countrylmt/discard",
					dataType: "json",
			...
			dataSource.fetch(function(){
				...
				$.each(jsonObj, function(i){
						...
						$(".confirm-del").html("<div>"+ "Discard the Change on "+validateResponse(jsonObj[i].countryId)+" " + "</div>");
    ...
    <body>
    	<div class="boci-wrapper">
    		...
    		<div class="content-wrapper">
					<div class="page-title">Maintenance  - Country Limit Maintenance (Collateral) - Discard Country Limit Change Request (Collateral)</div>	    		
