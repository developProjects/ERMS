...
<html lang="en">
 ...
 <meta http-equiv="x-ua-compatible" content="IE=10">
    ...
    $(document).ready(function(){
		...
		limitviewurl = window.sessionStorage.getItem('serverPath')+"limitTypeHierCr/getLmtTypeHierCr?lmtTypeCode="
				+ lmtTypeCode;
    	...
    	<div class="boci-limitType-wrapper">
    		...
    		<div class="updateLimit-content-wrapper form">
    			<form id="create_newlimit_form">
					 <div class="page-title">Maintenance - Limit Type Maintenance-Update Limit Type Change Request</div> 
					
					<input type="hidden" id="pagetitle" name="pagetitle" value="Update Limit Type Change Request">	  		
