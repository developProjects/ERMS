 	...
 	<script type="text/javascript">
 	 ...
 	 $(document).ready(function () {
		...
		function dataGrids(){
			...
			$(".empty-height").hide();
			openModal();
			var getSblLoanDetailURL = window.sessionStorage.getItem('serverPath')+"sbl/getLoanStockExpMonRpt?userId="+window.sessionStorage.getItem('username');
			...
			var activeDataSource = new kendo.data.DataSource({
				...
				$("#list").kendoGrid({
					...
					excel: {
						 allPages: true,
						 fileName: "Loan Stock Exp Monitoring Report"
					},
