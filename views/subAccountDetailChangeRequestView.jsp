			...
			function(){
				...
				*/
				...
				var dataSource = new kendo.data.DataSource({
					transport: {
						read: {
							url: window.sessionStorage.getItem('serverPath')+"subacct/getRecord?crId="+getURLParameters("crId")+"&userId="+window.sessionStorage.getItem("username")+"&bizUnit="+getURLParameters("bizUnit")+"&bookEntity="+getURLParameters("bookEntity")+"&dataSourceAppId="+getURLParameters("dataSourceAppId"),
							dataType: "json",
...
<body>
	<div class="boci-wrapper">
		...
		<div class="page-title">Sub Account RMD Change Request Maintenance - View</div>
	<!-- 	<input type="hidden" id="pagetitle" name="pagetitle"
			value="Sub Account RMD Change Request Maintenance - View "> -->
