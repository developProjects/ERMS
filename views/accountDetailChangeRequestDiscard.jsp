...
<body>
	<div class="boci-wrapper">
		...
		<div class="page-title">Account RMD Change Request Maintenance - Discard</div>
		<!-- <input type="hidden" id="pagetitle" name="pagetitle" value="Account RMD Change Request Maintenance - Discard "> -->
