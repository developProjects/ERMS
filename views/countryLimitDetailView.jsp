...
<html lang="en">
 ...
 <meta http-equiv="x-ua-compatible" content="IE=10">
    	...
    	var dataSource = new kendo.data.DataSource({
			...
			dataSource.fetch(function(){
				...
				$.each(jsonObj, function(i){
						...
						$(".command-button-Section").html("<button id=\"editBtn\"  type=\"button\" data-role=\"button\" class=\"k-button\" role=\"button\" aria-disabled=\"false\" tabindex=\"0\" onclick=\"toEdit('"+jsonObj[i].countryId+"','"+jsonObj[i].entity+"')\">Update</button></label> <label><button id=\"deleteBtn\"  type=\"button\" data-role=\"button\" class=\"k-button\" role=\"button\" aria-disabled=\"false\" tabindex=\"0\" onclick=\"toDelete('"+jsonObj[i].countryId+"','"+jsonObj[i].entity+"')\">Delete</button></label> <label><button id=\"backBtn\" onclick=\"toBack()\" type=\"button\" data-role=\"button\" class=\"k-button\" role=\"button\" aria-disabled=\"false\" tabindex=\"0\">Back</button>");
	...
	function toEdit(countryId,entity){
		window.location = "/ermsweb/countryLimitUpdate?countryId="+countryId+"&entity="+entity;
	}
	function toDelete(countryId,entity){
		window.location = "/ermsweb/countryLimitDelete?countryId="+countryId+"&entity="+entity;
	}
	function toBack(){
		//window.history.back();
    ...
    <body>
    	<div class="boci-wrapper">
    		...
    		<div class="content-wrapper">
					<div class="page-title">Maintenance  - Country Limit Maintenance (Collateral) -View Country Limit Detail (Collateral)</div>	    		
