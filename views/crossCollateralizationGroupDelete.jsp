    ...
    $(document).ready(function(){
    	...
    	var dataSource = new kendo.data.DataSource({
			transport: {
				...
				update:{
					type:"POST",
					url: window.sessionStorage.getItem('serverPath')+"xcollgroup/submit",//"/ermsweb/updateDataByccdId",
					dataType: "json",
			...
			dataSource.fetch(function(){
				...
				$.each(jsonObj, function(i){
						...
						$(".confirm-del").html("<div>"+ "Confirm to delete Cross Collateralization Group  "+validateResponse(jsonObj[i].xcollGroupId)+" " + "</div>");
    ...
    <body>
    	<div class="boci-wrapper">
    		...
    		<div class="content-wrapper">
					<div class="page-title">Maintenance - Cross Collateralization Group Maintenance  -  Remove Cross Collaterialization Group </div>	    		
