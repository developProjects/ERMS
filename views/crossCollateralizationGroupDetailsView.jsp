...
<html lang="en">
 ...
 <meta http-equiv="x-ua-compatible" content="IE=10">
    	...
    	var dataSource = new kendo.data.DataSource({
			...
			dataSource.fetch(function(){
				...
				$.each(jsonObj, function(i){
						...
						$(".command-button-Section").html("<button id=\"editBtn\"  type=\"button\" data-role=\"button\" class=\"k-button\" role=\"button\" aria-disabled=\"false\" tabindex=\"0\" onclick=\"toEdit('"+jsonObj[i].xcollGroupId+"')\">Update</button></label> <label><button id=\"deleteBtn\"  type=\"button\" data-role=\"button\" class=\"k-button\" role=\"button\" aria-disabled=\"false\" tabindex=\"0\" onclick=\"toDelete('"+jsonObj[i].xcollGroupId+"')\">Delete</button></label> <label><button id=\"backBtn\" onclick=\"toBack()\" type=\"button\" data-role=\"button\" class=\"k-button\" role=\"button\" aria-disabled=\"false\" tabindex=\"0\">Back</button>");
	...
	function toEdit(xcollGroupId){
		window.location = "/ermsweb/crossCollateralizationGroupUpdate?xcollGroupId="+xcollGroupId;
	}
	function toDelete(xcollGroupId){
		window.location = "/ermsweb/crossCollateralizationGroupDelete?xcollGroupId="+xcollGroupId;
	}
	function toBack(){
		//window.history.back();
    ...
    <body>
    	<div class="boci-wrapper">
    		...
    		<div class="content-wrapper">
					<div class="page-title">Maintenance - Cross Collateralization Group Maintenance  -  Cross Collaterialization Group  Detail View</div>	    		
