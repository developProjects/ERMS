...
<script>
			...
			*/
			...
			dataSource.fetch(function(){
				...
				$.each(jsonObj, function(i){
						...
						$("#financial_report_date_label").html("<label>"+toDateFormat(validateResponse(jsonObj[i].latestFinRptDate))+"</label>");
		...
		function toUpdate(uid, ccdId){
			window.location = "/ermsweb/viewCrUpdate?crId="+uid+"&ccdId="+ccdId+"&userId="+window.sessionStorage.getItem("username");
		}
...
<body>
	...
	<!-- <input type="hidden" id="pagetitle" name="pagetitle"
		value=" Client Counterparty RMD Detail Maintenance - View Client Counterparty Detail">
	<br> -->
