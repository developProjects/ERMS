 				...
 				function(){
					...
					*/
					...
					var dataSource = new kendo.data.DataSource({
						transport: {
							read: {
								url: window.sessionStorage.getItem('serverPath')+"acct/getRecord?acctId="+array[0]+"&bizUnit="+array[1]+"&bookEntity="+array[2]+"&dataSourceAppId="+array[3]+"&userId="+window.sessionStorage.getItem("username"),
								dataType: "json",
...
<body>
	<div id="boci-wrapper">
		...
		<div class="page-title">Account RMD Maintenance - Update </div>
		<!-- <input type="hidden" id="pagetitle" name="pagetitle"
			value="Account RMD Maintenance - Update "> -->
