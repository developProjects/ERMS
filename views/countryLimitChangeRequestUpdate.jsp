        		...
        		$('#lmtInCapital').on("blur", function() {
				 ...
				 countrydataSource.fetch(function(){
						...
						$.each(jsonObj, function(i){
								...
								$('#lmtInCapital').data("kendoNumericTextBox").value(validateResponse(jsonObj[i].lmtInCapital)),
		          		...
		          		var validator = $("#countryRating_form").kendoValidator().data("kendoValidator");	
		          		 ...
		          		 $("#saveBtn").kendoButton({
								click: function(){
										...
										countrydataSource.transport.options.update.url= window.sessionStorage.getItem('serverPath')+"countrylmt/save";
										...
										dataDatasource.set("lmtInCapital",$("#lmtInCapital").data("kendoNumericTextBox").value());
										dataDatasource.set("crStatus","Saved");
										//dataDatasource.set("entity","BOCI");
							...
							$("#submitBtn").kendoButton({
								click: function(){
									if (validator.validate()) {
										...
										var dataDatasource = countrydataSource.at(0);
										countrydataSource.transport.options.update.url= window.sessionStorage.getItem('serverPath')+"countrylmt/submit";
										dataDatasource.set("lmtCcy",$("#lmtCcy").data("kendoDropDownList").value());
										dataDatasource.set("lmtAmt",$("#lmtAmt").data("kendoNumericTextBox").value());
										dataDatasource.set("lmtInCapital",$("#lmtInCapital").data("kendoNumericTextBox").value());
    	...
    	<div class="boci-limitType-wrapper">
    		...
    		<div class="createLimit-content-wrapper form">
    			<form id="countryRating_form">
					<div class="page-title">Maintenance  - Country Limit Maintenance (Collateral) - Update Country Limit Change Request (Collateral)</div>	    		
